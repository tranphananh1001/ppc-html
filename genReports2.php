...
passthru('/usr/bin/php /srv/robots/syncdata.php '.$argv[2].'');
sleep(300);
passthru('/usr/bin/php /srv/robots/syncdata.php '.$argv[2].'');
echo "\033[31m =========2============ \033[0m  \n";
passthru('/usr/bin/php /srv/robots/lookup.php '.$argv[2]. '');
echo "\033[31m =========3============ \033[0m  \n";
passthru('/usr/bin/php /var/www/html/getReports1.php "-30 days" '.$argv[2].'');
?>